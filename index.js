...
Car.prototype.accelerate = function(fasterSpeed) {
...
Car.prototype.brake = function(slowSpeed) {
  this.speed -= slowSpeed;
  console.log(`Автомобіль ${this.brand} ${this.model} сповільнився до швидкості до швидкості ${this.speed} км/год`);
};
// Метод brake для гальмування прототипу Car,зменшує this.speed на передане число та виводить рядок в консоль в консоль: Автомобіль <brand> <model> сповільнився до швидкості <speed> км/год
...
Truck.prototype.specific = function(number) {
 ...
 } else if (number <= this.towingCapacity && number > 0){ 
  console.log(`Буксирування навантаження...`)
 } else {console.error()};
};
// Додатковий метод specific для прототипу Trucks, примає число якщо воно більше towingCapacity виводить рядок в консоль: Навантаження занадто важке для буксирування, якщо ні то рядок Буксирування навантаження...
let newTruck = new Truck("Toyota", "Tundra", 2019, 20000, "Red", "V8", 10000, "Gasoline", "Automatic", 4, 5600);
 ...
 * | weight           | 5600                         |
 */
console.log(newTruck.specific(12000));
// Викликаємо метод tow (а може тут має бути метод specific?) з вагою меншою за towingCapacity
console.log(newTruck.specific(300));
// Викликаємо метод tow (а може тут має бути метод specific?) з вагою більшою за towingCapacity
Car.prototype.drive = function(km) {
  this.kilometers = (this.kilometers || 0) + km;  
...
let boundFunction = newCar.drive.bind(newCar)
...
let newElectricCar = new ElectricCar("Tesla", "Model S", 2020, 10000, 100);
